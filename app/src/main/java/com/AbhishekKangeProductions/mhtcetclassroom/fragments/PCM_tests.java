...
public class PCM_tests extends Fragment {
    ...
    public static PCM_tests newInstance(String param1, String param2) {
        PCM_tests fragment = new PCM_tests();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_p_c_m_tests, container, false);


        recyclerView = view.findViewById(R.id.testListRV);
        database = FirebaseDatabase.getInstance();

        ShimmerFrameLayout shimmerFrameLayout = new ShimmerFrameLayout(getContext());
        shimmerFrameLayout = view.findViewById(R.id.mShimmerViewContainerPcm);
        ...
        database.getReference().child("TestNos").child("PCM").addValueEventListener(new ValueEventListener() {
            @Override
