...
public class chemistryFormulaFrag extends Fragment {
    ...
    public chemistryFormulaFrag() {

    }



    public static chemistryFormulaFrag newInstance(String param1, String param2) {
        chemistryFormulaFrag fragment = new chemistryFormulaFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_chemistry_formula, container, false);

        formulaRv = view.findViewById(R.id.chemistryFormularv);
        ...
        database.getReference().child("Formulas").child("Chemistry").addValueEventListener(new ValueEventListener() {
            @Override
