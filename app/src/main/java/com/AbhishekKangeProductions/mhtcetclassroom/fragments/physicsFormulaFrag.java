...
public class physicsFormulaFrag extends Fragment {
    ...
    public physicsFormulaFrag() {

    }


    public static physicsFormulaFrag newInstance(String param1, String param2) {
        physicsFormulaFrag fragment = new physicsFormulaFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_physics_formula, container, false);
        ...
        database.getReference().child("Formulas").child("Physics").addValueEventListener(new ValueEventListener() {
            @Override
