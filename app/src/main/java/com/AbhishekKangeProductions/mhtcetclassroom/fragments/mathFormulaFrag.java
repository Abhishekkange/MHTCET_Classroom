...
public class mathFormulaFrag extends Fragment {
    ...
    public mathFormulaFrag() {

    }


    public static mathFormulaFrag newInstance(String param1, String param2) {
        mathFormulaFrag fragment = new mathFormulaFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_math_formula, container, false);


        formulaRv = view.findViewById(R.id.mathsFormulaLisRv);
        ...
        database.getReference().child("Formulas").child("Maths").addValueEventListener(new ValueEventListener() {
            @Override
